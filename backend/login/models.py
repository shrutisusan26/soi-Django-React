...
class Startup(models.Model):
    ...
    # user=models.OneToOneField(Investor,on_delete=models.CASCADE)
    interested_investors=models.ManyToManyField(Investor, related_name='interested_investors', blank=True,through='InvestorInstance')
...
class InvestorInstance(models.Model):
    investor=models.ForeignKey(Investor,on_delete=models.CASCADE,blank=True)
    notifyInvestor=models.ForeignKey(Startup,on_delete=models.CASCADE)
